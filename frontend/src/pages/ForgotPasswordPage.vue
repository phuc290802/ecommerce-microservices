    ...
    <div class="auth-container">
      <div class="auth-card">
        ...
        <div v-if="success" class="alert alert-success mb-2">
          ✓ Đã gửi yêu cầu reset mật khẩu. Kiểm tra console server để lấy link.
        </div>

        <form v-if="!success" @submit.prevent="handleForgot" class="auth-form">
...
.orb-1 { width: 400px; height: 400px; background: #6366f1; top: -100px; right: -80px; animation: float1 8s ease-in-out infinite; }
.orb-2 { width: 350px; height: 350px; background: #3b82f6; bottom: -80px; left: -60px; animation: float2 10s ease-in-out infinite; }
